...
public class Constants {
    ...
    public final static String HOME_FXML_PATH = String.format("%s/startFrame.fxml", FXML_PATH);
    public final static String REGISTER_FXML_PATH = String.format("%s/registerFrame.fxml", FXML_PATH);
